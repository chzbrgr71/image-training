...
events.on("push", (brigadeEvent, project) => {
    ...
    helm.tasks = [
        `helm install --name tf-training-${jobIdentifier} --set name=${jobIdentifier},container.image=${acrName}.azurecr.io/${image},container.imageTag=${imageTag} ./src/chart-deploy`
    ]
